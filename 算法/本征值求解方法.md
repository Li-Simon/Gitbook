...
##Gram-Schmidt 变换
对矩阵A进行分解，首先定义投影：  
$$\kern{8 em} proj_{\mathbf{u}}\mathbf{a} = \frac{[\mathbf{u},\mathbf{q}]}{[\mathbf{u},\mathbf{u}]}\mathbf{u}$$  
然后：  
...
$$\kern{4 em} \mathbf{u_3} = \mathbf{a_3} - proj_{\mathbf{u_1}}\mathbf{a_3}-proj_{\mathbf{u_2}}\mathbf{a_3}$$$$\kern{2 em} \mathbf{e_2} = \frac{\mathbf{u_3}}{||\mathbf{u_3}||}$$  
$$\kern{4 em} \mathbf{u_n} = \mathbf{a_n} - \sum proj_{\mathbf{u_1}}\mathbf{a_3}-proj_{\mathbf{u_2}}\mathbf{a_3}$$$$\kern{2 em} \mathbf{e_2} = \frac{\mathbf{u_3}}{||\mathbf{u_3}||}$$
