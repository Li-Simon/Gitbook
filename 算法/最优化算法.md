...
代入：$$\mathbf{\mathbf{P^T_{k}Ax_*} = b}$$,$$\mathbf{u^TAv = 《u,v》_A}$$,利用$$i != k$$有$$\mathbf{《p_k,p_i》_A = 0}$$ 就得到：
$$\mathbf{《p_k,b》 = {\alpha}_k《p_k,p_k》_A}$$
所以：
$${\alpha}_k = \frac{\mathbf{《p_k,b》}}{\mathbf{《p_k,p_k》}_A}$$
