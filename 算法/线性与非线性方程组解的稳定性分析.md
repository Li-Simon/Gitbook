...
当然我们有很多方法来求解方程\(4.1\),比如[梯度下降法](https://en.wikipedia.org/wiki/Gradient_descent)，[牛顿法](https://en.wikipedia.org/wiki/Newton's_method_in_optimization)，[高斯-牛顿法](https://en.wikipedia.org/wiki/Gauss–Newton_algorithm)，以及[Levenberg-Marquardt](https://en.wikipedia.org/wiki/Levenberg–Marquardt_algorithm)  
