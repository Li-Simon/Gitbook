...
&emsp;&emsp;&emsp;&emsp;$$\mathbf{x_0} = c_1\mathbf{\alpha_1} + c_2\mathbf{\alpha_2}+...+c_n\mathbf{\alpha_n}$$  
则：  
&emsp;&emsp;&emsp;&emsp;$$A^k\mathbf{x_0} = \displaystyle \sum_{i=1}^n c_i \lambda_i^k \mathbf{\alpha_i} = \displaystyle \lambda_1^k\sum_{i=1}^n c_i (\frac{\lambda_i}{\lambda_1})^k \mathbf{\alpha_i}$$  
...
&emsp;&emsp; $$x_{i+1} = y_{i+1}/||y_{i+1}||_2$$   
&emsp;&emsp; $$\lambda_{i+1} = x_{i+1}^T(A-\sigma I)^{-1}x_{i+1}$$   
&emsp;&emsp; i=i+1
&emsp; until收敛  
