...
假设以outlook为分支标准能带来最大的信息增益，则我们将数据集D一分为3(sunny, overcast, rain)，D1,D2,D3;对D1,D2,D3分别重复原来D的过程，寻找D1,D2,D3中的一个分支属性，使得信息增益最大。每次分割一个叶子节点，把叶子节点作为根节点，选择的属性属性值作为新的叶子节点，来一步步的构建决策树。     
