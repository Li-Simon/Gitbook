...
&emsp;&emsp;$$f()$$是激活函数。  
&emsp;&emsp;$$\mathbf{b^{(l)}}=[b^{(l)}_1,b^{(l)}_2,...,b^{(l)}_{n_l}]$$表示第l层的偏置。
&emsp;&emsp;$$\mathbf{z^{(l)}}=[z^{(l)}_1,z^{(l)}_2,...,z^{(l)}_{n_l}]$$表示第l层神经元的的状态。    
&emsp;&emsp;$$\mathbf{a^{(l)}}=[a^{(l)}_1,a^{(l)}_2,...,a^{(l)}_{n_l}]$$表示第l层神经元的的激活值。      
